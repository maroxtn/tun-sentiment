...
def main():
    ...
    train, test = load_sentiment_dataset(directory=args.dataset_dir, iterim=True)
    ...
    models = SentimentTrainer(text, train.labels, fn, args.lang_prefix, args.folds, args.batch_size
